...
fro 	= "^i(/home/randalltux/.icons/xbm8x8/fro_01.xbm)"
...
myWorkspaces	:: [String]
myWorkspaces	= clickable $ [ "^i(/home/randalltux/.icons/stlarch/grid.xbm)  main "++fro++""
			      , "^i(/home/randalltux/.icons/xbm8x8/cpu.xbm)  web "++fro++""
			      , "^i(/home/randalltux/.icons/xbm8x8/phones.xbm)  music "++fro++""
			      , "^i(/home/randalltux/.icons/xbm8x8/info_02.xbm)  coding "++fro++""
			      , "^i(/home/randalltux/.icons/xbm8x8/fox.xbm)  fuck "++fro++""
			      ]
		where clickable l 	= [ "^ca(1,xdotool key super+" ++ show (n) ++ ")" ++ ws ++ "^ca()" |
					    (i,ws) <- zip [1..] l,
					    let n = i ]

laycon		= "/home/randalltux/.icons/stlarch/"
...
main = do
	...
	bar2 <- spawnPipe "sh /home/randalltux/.xmonad/dzenbar.sh"
        -- conkymajestic <- spawnPipe "sh /home/randalltux/scripts/configs/gegenokitaro/scripts/majestic/launchall.sh"
        autostart <- spawnPipe "sh /home/randalltux/.xmonad/autostart.sh"
