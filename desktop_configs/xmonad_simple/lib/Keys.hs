module Keys where
  ...
  myKeys        =
    ...
    , ((mod4Mask, xK_f), spawn "google-chrome-stable")                  -- launch google chrome
    ...
    , ((mod4Mask, xK_t), spawn "urxvt")                                 -- urxvt client
    ...
    , ((mod4Mask, xK_q),  spawn "thunar")                               -- launch thunar file manager
    ]
