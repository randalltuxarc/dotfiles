...
myIcon = "/home/randalltux/.icons/xbm8x8/"

main = do
  bar <- spawnPipe statsbar
  bar3 <- spawnPipe "sh /home/randalltux/scripts/configs/gegenokitaro/scripts/powerline.sh"
...
icondir = "/home/randalltux/.icons/xbm8x8"

myLogHook h = do
  dynamicLogWithPP $ tryPP h
tryPP :: Handle -> PP
tryPP h = defaultPP {
        ppCurrent	    	=   wrap "^p(2)^fg(#0088cc)^i(/home/randalltux/.icons/xbm8x8/corner_left.xbm)^fg(#0088cc)^r(38x12)^p(-40)^ib(1)^fg()""^fg(#0088cc)^i(/home/randalltux/.icons/xbm8x8/corner_right.xbm)^fg()" 
      , ppVisible           =   wrap "^p(2)^fg(#b8d68c)^i(/home/randalltux/.icons/xbm8x8/corner_left.xbm)^fg(#b8d68c)^r(38x12)^p(-40)^ib(1)^fg()""^fg(#b8d68c)^i(/home/randalltux/.icons/xbm8x8/corner_right.xbm)^fg()"
      , ppHidden            =   wrap "^p(2)^fg(#818181)^i(/home/randalltux/.icons/xbm8x8/corner_left.xbm)^fg(#818181)^r(38x12)^p(-40)^ib(1)^fg()""^fg(#818181)^i(/home/randalltux/.icons/xbm8x8/corner_right.xbm)^fg()"
      , ppHiddenNoWindows   =   wrap "^p(2)^fg(#404040)^i(/home/randalltux/.icons/xbm8x8/corner_left.xbm)^fg(#404040)^r(38x12)^p(-40)^ib(1)^fg()""^fg(#404040)^i(/home/randalltux/.icons/xbm8x8/corner_right.xbm)^fg()"
      , ppUrgent            =   dzenColor (colLook Red   0)
                                          (colLook BG    0) . wrap "^i(/home/randalltux/.icons/xbm8x8/corner_left.xbm)""^i(/home/randalltux/.icons/xbm8x8/corner_right.xbm)"
      , ppWsSep             =   ""
      , ppSep               =   " ^fg(#FFFFFF)::^fg() "
    ...
    where icon1 = "^i(/home/randalltux/.icons/stlarch/tile.xbm)^ca()"
          icon2 = "^i(/home/randalltux/.icons/stlarch/monocle.xbm)^ca()"
          icon3 = "^i(/home/randalltux/.icons/stlarch/bstack.xbm)^ca()"
          icon4 = "^i(/home/randalltux/.icons/stlarch/monocle2.xbm)^ca()"
	  icon5 = "^i(/home/randalltux/.icons/stlarch/bstack2.xbm)^ca()"
	  icon6 = "^i(/home/randalltux/.icons/stlarch/float.xbm)^ca()"
